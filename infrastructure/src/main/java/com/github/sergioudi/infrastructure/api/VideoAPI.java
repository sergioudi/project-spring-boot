package com.github.sergioudi.infrastructure.api;
...
public interface VideoAPI {
    ...
    ResponseEntity<?> createVideo(@RequestBody CreateVideoRequest input);
    ...
    Pagination<VideoListResponse> listVideos(
    ...
    ResponseEntity<?> updateById(@PathVariable(name = "id") String id, @RequestBody UpdateVideoRequest input);
